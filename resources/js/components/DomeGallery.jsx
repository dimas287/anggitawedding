...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    el => {
      ...
      const rawEmbed = parent.dataset.embed || '';
      
      let mediaEl;
      if (rawType === 'video') {
         if (rawEmbed) {
            mediaEl = document.createElement('iframe');
            let embedSrc = rawEmbed;
            ...
            mediaEl.muted = false; // allow sound when enlarged
            mediaEl.loop = true;
            ...
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  {it.type === 'video' ? (
                     it.embed ? (
                       <iframe src={it.embed} frameBorder="0" allow="autoplay; fullscreen" loading="lazy" />
                     ) : (
