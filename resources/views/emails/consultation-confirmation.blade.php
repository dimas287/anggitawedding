...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #1a0a2e, #4a2c6e); padding: 30px; text-align: center; }
        ...
        .reminder-box { background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 15px; margin: 20px 0; font-size: 13px; color: #856404; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>📅 Konsultasi Dikonfirmasi!</h1>
            <p>Jadwal konsultasi Anda telah berhasil dikonfirmasi</p>
        </div>
        <div class="body">
            ...
            <p style="color:#555;font-size:13px;line-height:1.6;margin-top:8px">
                Jadwal konsultasi Anda dengan tim <strong>Anggita Wedding Organizer</strong> telah dikonfirmasi.
                Kami siap membantu mewujudkan pernikahan impian Anda!
            </p>

            <div class="card">
                <h3>Detail Konsultasi</h3>
                <div class="info-row"><span class="label">Kode :</span><span class="value" style="color:#7d3c98">{{ $consultation->consultation_code }}</span></div>
                ...
                <div class="info-row"><span class="label">Alamat Kantor :</span><span class="value">Jl. Bulak Setro Indah 2 Blok C No. 5, Surabaya</span></div>
                @endif
            </div>

            <div class="reminder-box">
                ⚠️ <strong>Pengingat: </strong> Harap hadir tepat waktu. Jika ada kendala, hubungi kami minimal 2 jam sebelum jadwal konsultasi.
            </div>

            <a href="{{ route('landing') }}" class="cta-btn">
                🏠 Kunjungi Website Kami
            </a>

            <p style="color:#888;font-size:12px;text-align:center">
                Hubungi kami via WhatsApp: <a href="https://wa.me/6281231122057" style="color:#D4AF37">+62 812-3112-2057</a>
            </p>
        </div>
