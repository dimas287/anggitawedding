        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="answer" rows="5" required
                          ...
                          placeholder="Tuliskan jawaban lengkap di sini...">{{ old('answer') }}</textarea>
            ...
            <div class="pt-4">
                <button type="submit" class="w-full gold-gradient text-white font-bold py-4 rounded-xl shadow-lg hover:opacity-90 transition-all">
                    Simpan FAQ
                </button>
            </div>
        </form>
