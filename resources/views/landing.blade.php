...
<section class="bg-white dark:bg-[#0A0A0A] section-glow transition-colors duration-500 relative z-10 min-h-screen flex flex-col justify-center" id="layanan">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col w-full py-12 lg:py-24">
        {{-- Header --}}
        <div id="harmoni-header" class="text-center pb-4 lg:pb-12 sticky top-12 lg:top-24 z-50 pointer-events-none transition-all duration-700 ease-in-out shrink-0">
