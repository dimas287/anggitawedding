...
<div class="min-h-screen pt-28 pb-16 bg-transparent">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="packageExplorer('{{ $packagesByCategory->keys()->first() ?? 'rumahan' }}')">
        ...
        @if($packages->isEmpty())
            <div class="glass-card dark:bg-[#111] dark:border-[#333] rounded-3xl p-10 mb-12 border border-white/60 shadow-xl text-center">
                            ...
                            <div class="grid grid-cols-1 gap-4 mb-8 flex-1 items-start auto-rows-min">
                                @forelse($sections as $section)
                                    <div class="rounded-2xl border border-gray-100 dark:border-gray-800 bg-white/60 dark:bg-[#1A1A1A]/60 p-4 flex flex-col gap-2 min-h-[180px] relative group">
                                        @if($section['title'])
                                            <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 font-bold mb-1">{{ $section['title'] }}</p>
                                        @endif
                                        <div class="relative flex-1">
                                            ...
                                            <div class="feature-scroll-fade pointer-events-none absolute bottom-0 left-0 right-2 h-10 bg-gradient-to-t from-white/95 dark:from-[#1A1A1A]/95 to-transparent rounded-b-lg flex items-end justify-center pb-1 transition-opacity">
                                                <div class="flex items-center gap-1 text-[10px] text-gray-400 dark:text-gray-500 animate-bounce">
                                                    <i class="fas fa-chevron-down text-[8px]"></i>
                                                    <span class="uppercase tracking-tighter font-bold">Scroll</span>
                                                </div>
                                            </div>
                                            @endif
                                        </div>
