...
@section('content')
<div class="{{ $isApp ? 'py-4 px-2' : 'min-h-screen pt-24 pb-16 px-2' }} bg-[#0f0f11]">
    <div class="max-w-md mx-auto px-2">
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center mb-4">
                <i class="fas fa-comments text-white text-3xl"></i>
            </div>
            <h1 class="font-playfair text-3xl font-bold text-white">Konsultasi Gratis</h1>
            <p class="text-gray-400 text-sm mt-3 px-2 leading-relaxed">Ceritakan impian pernikahan Anda. Kami siap membantu tanpa biaya apapun!</p>
        </div>

        <div class="bg-[#151515] rounded-[24px] shadow-xl p-6 md:p-8 border border-white/5">
            ...
            <form action="{{ route('consultation.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex flex-col gap-5">
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Nama Lengkap <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">No. WhatsApp <span class="text-red-500">*</span></label>
                        <input type="tel" name="phone" value="{{ old('phone', auth()->user()?->phone) }}" required
                               class="w-full bg-[#202020] border-none rounded-xl px-4 py-3.5 text-sm text-white focus:ring-1 focus:ring-white/20 transition-all placeholder-gray-500"
                               placeholder="085648907544">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Email <span class="text-red-500">*</span></label>
                        <input type="email" name="email" value="{{ old('email', auth()->user()?->email) }}" required
                               class="w-full bg-[#202020] border-none rounded-xl px-4 py-3.5 text-sm text-white focus:ring-1 focus:ring-white/20 transition-all placeholder-gray-500"
                               placeholder="dimasaw728@gmail.com">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Tanggal Konsultasi <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Jam Konsultasi <span class="text-red-500">*</span></label>
                        <select name="preferred_time" required
                                class="w-full bg-[#202020] border-none rounded-xl px-4 py-3.5 text-sm text-white focus:ring-1 focus:ring-white/20 transition-all">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Jenis Konsultasi <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Rencana Tanggal Pernikahan</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-300 mb-2 ml-1">Ceritakan Impian Pernikahan Anda</label>
                        <textarea name="message" rows="3"
                                  class="w-full bg-[#202020] border-none rounded-xl px-4 py-3.5 text-sm text-white focus:ring-1 focus:ring-white/20 transition-all placeholder-gray-500 resize-none"
        ...
        <div class="mt-6 flex flex-wrap gap-3 justify-center text-center text-xs">
            <div class="bg-[#151515] rounded-xl px-4 py-3 shadow-sm border border-white/5 flex items-center gap-2 text-gray-400"><i class="fas fa-check-circle text-green-500"></i> Gratis</div>
            <div class="bg-[#151515] rounded-xl px-4 py-3 shadow-sm border border-white/5 flex items-center gap-2 text-gray-400"><i class="fas fa-clock text-blue-500"></i> Cepat</div>
            <div class="bg-[#151515] rounded-xl px-4 py-3 shadow-sm border border-white/5 flex items-center gap-2 text-gray-400"><i class="fas fa-shield-alt text-purple-500"></i> No Commit</div>
        </div>
    </div>
</div>
@endsection
